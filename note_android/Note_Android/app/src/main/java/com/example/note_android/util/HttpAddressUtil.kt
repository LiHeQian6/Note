...
class HttpAddressUtil {
    companion object{
        ...
        //我的关注
        private const val MY_LIKE = "followee"
        //我的粉丝
        private const val LIKE_ME = "follower"
        ...
        fun getMyLike(): String{
            return this.IP+this.MY_LIKE
        }

        fun getLikeMe(): String{
            return this.IP+this.LIKE_ME
        }
    }
}